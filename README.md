...
#### Table 1 — Transcription Accuracy (WER)

| Sample | Accuracy | WER | Rating |
|---|---:|---:|---|
| `sample_001` | 0.962 | 0.038 | PERFECT |
| `sample_002` | 0.931 | 0.069 | GOOD |
| `sample_003` | 0.948 | 0.052 | GOOD |
| `sample_004` | 0.907 | 0.093 | GOOD |
| `sample_005` | 0.986 | 0.014 | PERFECT |
| `sample_006` | 0.927 | 0.073 | GOOD |
| `sample_007` | 0.908 | 0.092 | GOOD |
| `sample_008` | 0.980 | 0.020 | PERFECT |
| `sample_009` | 0.958 | 0.042 | PERFECT |
| `sample_010` | 0.880 | 0.120 | GOOD |
| **AVERAGE** | **0.939** | **0.061** |  |

#### Table 2 — Documentation Quality (ROUGE-L)

| Sample | ROUGE-L | Rating |
|---|---:|---|
| `sample_001` | 0.826 | PERFECT |
| `sample_002` | 0.736 | PERFECT |
| `sample_003` | 0.740 | PERFECT |
| `sample_004` | 0.500 | GOOD |
| `sample_005` | 0.759 | PERFECT |
| `sample_006` | 0.722 | PERFECT |
| `sample_007` | 0.798 | PERFECT |
| `sample_008` | 0.716 | PERFECT |
| `sample_009` | 0.609 | GOOD |
| `sample_010` | 0.683 | GOOD |
| **AVERAGE** | **0.709** |  |

These results satisfy **NfReq5** on average, and the transcription benchmark shows strong performance with an average accuracy of **0.939** across the 10 reference workflows.
...
- **Current outcome:** The benchmark averages are **0.939** transcription accuracy, **0.061** WER, and **0.709** ROUGE-L, meeting the documented quality targets overall.
...
- **Current outcome:** The timing tests passed, confirming that DocuFlow satisfies both **NfReq1** and **NfReq2** under the benchmark setup.
